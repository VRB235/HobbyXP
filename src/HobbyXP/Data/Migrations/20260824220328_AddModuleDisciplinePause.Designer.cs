...
namespace HobbyXP.Data.Migrations
{
    ...
    [Migration("20260824220328_AddModuleDisciplinePause")]
    partial class AddModuleDisciplinePause
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HobbyXP.Models.Core.ModuleDisciplinePause", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ModuleDisciplinePauses", (string)null);
                });
            ...
            modelBuilder.Entity("HobbyXP.Models.Physical.RunningSessionSeries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("RunningSessionId", "SortOrder");

                    b.ToTable("RunningSessionSeries", (string)null);
                });
            ...
            modelBuilder.Entity("HobbyXP.Models.Physical.RunningSessionSeries", b =>
                {
                    b.HasOne("HobbyXP.Models.Physical.RunningSession", "RunningSession")
                        .WithMany("Series")
